  ...
  return (
    <div className="bg-background min-h-screen flex flex-col">
      ...
      {/* THE FIX: This main tag restricts the width to 1280px and centers it. 
        If this is missing, the image will take over the whole screen.
      */}
      <main className="w-full max-w-[1280px] mx-auto px-4 md:px-12 py-8 flex-grow">
        ...
        {/* THE FIX: The Grid. 
          lg:grid-cols-2 forces the left side (images) and right side (text) to sit side-by-side on desktop.
        */}
