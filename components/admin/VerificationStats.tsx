    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
      <div className="bg-white p-6 rounded-xl border border-outline-variant elevation-1">
        <div className="flex justify-between items-start mb-4">
          ...
          <span className="text-[#ba1a1a] text-xs font-bold bg-[#ba1a1a]/10 px-2 py-1 rounded">+12% vs last week</span>
        </div>
      ...
      <div className="bg-white p-6 rounded-xl border border-outline-variant elevation-1">
        <div className="flex justify-between items-start mb-4">
          ...
          <span className="text-primary text-xs font-bold bg-primary/10 px-2 py-1 rounded">+82 this month</span>
        </div>
        <p className="text-xs text-on-surface-variant uppercase font-bold tracking-widest mb-1">Verified Today</p>
        <h3 className="text-3xl font-bold text-on-surface">14</h3>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl border border-outline-variant elevation-1">
        ...
        <h3 className="text-3xl font-bold text-on-surface">18.5h</h3>
      </div>
    </div>
  );
}